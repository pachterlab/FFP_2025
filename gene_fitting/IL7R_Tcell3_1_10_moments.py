import sys
# Add path to Monod source code.
sys.path.insert(0, '/home/user/monod/src/monod')
...
h5ad_filepath = './combined_adata_tcells_3_with_ambiguous.h5ad'  # Path to save the .h5ad file
...
fit_10x_10k = inference.perform_inference(h5ad_filepath, fitmodel, use_lengths=False,
                                         ...
                                         num_cores=48, n_genes=1, genes_to_fit=['ENSG00000168685'],
                                        ...
                                        samp_lb=samp_lb,samp_ub=samp_ub,
                                         gridsize=gridsize, exclude_sigma=True, dataset_string='IL7R_Tcell3_1_10_moments_amb')

with open('./IL7R_Tcell3_1_10_moments_amb/ProteinBursty_Poisson_2x2x2/monod_adata.pkl', 'rb') as file:
